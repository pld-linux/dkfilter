...
podpisywanie i weryfikację wiadomości DomainKeys. Zawiera dwa
oddzielne filtry, filtr "outbound" do podpisywania poczty wychodzącej
oraz filtr "inbound" do weryfikacji podpisów poczty przychodzącej.
Filtry mogą pracować w filtrach zawartości Postfiksa Before-Queue
(przed kolejką) lub After-Queue (za kolejką).
